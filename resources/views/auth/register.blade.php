    ...
    <div class="col s m5 card-col register-container-column">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    <div class="col s6">
                        <input class="filled-in" type="checkbox" id="science" />
                        <label for="science">Science</label>
                    </div>

                    <div class="col s6">
                        <input class="filled-in" type="checkbox" id="technology" />
                        <label for="technology">Technology</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col s6">
                        <input class="filled-in" type="checkbox" id="engineering" />
                        <label for="engineering">Engineering</label>
                    </div>

                    <div class="col s6">
                        <input class="filled-in" type="checkbox" id="mathematics" />
